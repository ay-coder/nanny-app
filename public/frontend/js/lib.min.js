...
//
// Add Starr JS
var slice=[].slice;!function(t,s){var n;window.Starrr=n=function(){function s(s,n){var r,i,a;(this.options=t.extend({},this.defaults,n),this.$el=s,this.createStars(),this.syncRating(),this.options.readOnly)||(this.$el.on("mouseover.starrr","a",(r=this,function(t){return r.syncRating(r.getStars().index(t.currentTarget)+1)})),this.$el.on("mouseout.starrr",(i=this,function(){return i.syncRating()})),this.$el.on("click.starrr","a",(a=this,function(t){return a.setRating(a.getStars().index(t.currentTarget)+1)})),this.$el.on("starrr:change",this.options.change))}return s.prototype.defaults={rating:void 0,max:5,readOnly:!1,emptyClass:"fa fa-star-o",fullClass:"fa fa-star",change:function(t,s){}},s.prototype.getStars=function(){return this.$el.find("a")},s.prototype.createStars=function(){var t,s,n;for(n=[],t=1,s=this.options.max;1<=s?t<=s:t>=s;1<=s?t++:t--)n.push(this.$el.append("<a href='javascript:void(0)' />"));return n},s.prototype.setRating=function(t){return this.options.rating===t&&(t=void 0),this.options.rating=t,this.syncRating(),this.$el.trigger("starrr:change",t)},s.prototype.getRating=function(){return this.options.rating},s.prototype.syncRating=function(t){var s,n,r,i,a;for(t||(t=this.options.rating),s=this.getStars(),a=[],n=r=1,i=this.options.max;1<=i?r<=i:r>=i;n=1<=i?++r:--r)a.push(s.eq(n-1).removeClass(t>=n?this.options.emptyClass:this.options.fullClass).addClass(t>=n?this.options.fullClass:this.options.emptyClass));return a},s}(),t.fn.extend({starrr:function(){var s,r;return r=arguments[0],s=2<=arguments.length?slice.call(arguments,1):[],this.each(function(){var i;if((i=t(this).data("starrr"))||t(this).data("starrr",i=new n(t(this),r)),"string"==typeof r)return i[r].apply(i,s)})}})}(window.jQuery);
// End Starr JS