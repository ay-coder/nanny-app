...
@section('content')
    ...
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title"> Sitter Earning Report</h3>
        ...
        <div class="box-body">
            ...
            <div class="box-tools">
                <div class="col-md-12">
                    <div class="col-md-3">
                    {{ Form::select('user_id', ['' => 'Please Select User'] + $allUsers, session('sitterEarningFilter') ? session('sitterEarningFilter') : '', ['id' => 'user_id', 'class' => 'form-control']) }}
                    </div>
                    <div class="col-md-3">
