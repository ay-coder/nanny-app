    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            ...
            <div class="box-tools">
                <div class="col-md-12">
                    <div class="col-md-3">
                    {{ Form::select('user_id', ['' => 'Please Select User'] + $allUsers, session('subscriptionFilter') ? session('subscriptionFilter') : '', ['id' => 'user_id', 'class' => 'form-control']) }}
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{!! route('admin.subscription.index', ['download' => 1]) !!}" target="_blank" class="btn btn-primary" id="ExcelBtn">Excel</a>
                    </div>
                </div> 
            </div>
