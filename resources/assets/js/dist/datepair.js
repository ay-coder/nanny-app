	...
	Datepair.prototype = {
		...
		_timeChanged: function(target){
			...
			if (this.settings.anchor == 'start' && hasClass(target, this.settings.startClass))
			{
				...
				var fixDelta = 3600000 * 3;				
				endTime = this._setTimeAndReturn(this.endTimeInput, new Date(startTime.getTime() +  fixDelta));
			...
			else
			{
				...
				var momStart 	= moment(startTime),
					momEnd 		= moment(endTime),
					momDiff 	= momEnd.diff(momStart);
