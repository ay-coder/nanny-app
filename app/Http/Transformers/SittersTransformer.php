...
class SittersTransformer extends Transformer
{
    ...
    public function transform($item)
    {
        ...
        $response =  [
            ...
            "vacation_mode"         => (int) $item->vacation_mode,
            "start_time"            => $this->nulltoBlank($item->sitter_start_time),
            "end_time"              => $this->nulltoBlank($item->sitter_end_time),
    ...
    public function calendarTransform($items)
    {
        ...
        foreach($items as $item)
        {
            ...
            $response[$sr] = [
                ...
                "start_time"        =>  $item->sitter_start_time,
                "end_time"          =>  $item->sitter_end_time,
