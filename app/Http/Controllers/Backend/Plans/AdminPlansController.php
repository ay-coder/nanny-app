<?php namespace App\Http\Controllers\Backend\Plans;
...
class AdminPlansController extends Controller
{
     ...
     * @var string
     */
    protected $createSuccessMessage = "Plans Created Successfully!";
     ...
     * @var string
     */
    protected $editSuccessMessage = "Plans Edited Successfully!";
     ...
     * @var string
     */
    protected $deleteSuccessMessage = "Plans Deleted Successfully";
