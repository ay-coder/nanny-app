<?php namespace App\Models\Parents\Traits\Attribute;
...
trait Attribute
{
    ...
    public function getEditButtonAttribute($routes, $prefix = 'admin', $isAdmin = false)
    {
        ...
        return '<a href="'.route($prefix .'.'. $routes->viewRoute, $id).'" class="btn btn-xs btn-primary"><i class="fa fa-eye" data-toggle="tooltip" data-placement="top" title="view"></i></a> ';
    }
    ...
    {
        $repository = new EloquentParentsRepository;
